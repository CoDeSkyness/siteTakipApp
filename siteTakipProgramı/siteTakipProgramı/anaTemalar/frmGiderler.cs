...
namespace siteTakipProgramı
{
    public partial class frmGiderler : Form
    {
        ...
        public void tablogetir()
        {
            dt = new DataTable();
            con.Open();
            adapter = new MySqlDataAdapter("SELECT * FROM tblgider", con);
        ...
        public void dataİsimler()
        {
            ...
            dataGridView1.Columns[1].HeaderText = "Gider Türü";
        ...
        {
            MessageBox.Show("Değerli Kullanıcı Programın Bu Sayfasında Giderlerinizi Görebileceksiniz Gider Ekleme, Silme ve Düzenleme yapmak için " +
        ...
        private void txtAra_TextChanged(object sender, EventArgs e)
        {
            ...
            if (rBtnGiderTuru.Checked == true)
            {
                DataView dv = dt.DefaultView;
                dv.RowFilter = "giderTuru LIKE'" + txtAra.Text + "%'";
                dataGridView1.DataSource = dv;
            }
        }
        ...
        {
            frmGiderDuzenle giderDuzenle = new frmGiderDuzenle();
            giderDuzenle.Show();
        }
    }
}
