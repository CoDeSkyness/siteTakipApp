...
{
    public partial class frmBina : Form
    {
        ...
        public void tablogetir()
        {
            dt = new DataTable();
            con.Open();
            adapter = new MySqlDataAdapter("SELECT * FROM tblbina", con);
        ...
        public void dataİsimler()
        {
            ...
            dataGridView1.Columns[2].HeaderText = "Daire Sayısı";
        }
        ...
        {
            MessageBox.Show("Değerli Kullanıcı Programın Bu Sayfasında Binalarınızı Görebileceksiniz Bina Ekleme, Silme ve Düzenleme yapmak için " +
                "'Ekle' Butonuna Basabilirsiniz.", "Bilgilendirme", MessageBoxButtons.OK, MessageBoxIcon.Question);
        }

        private void frmBina_Load(object sender, EventArgs e)
        {
            timer1.Start();
        ...
        {
            frmBinaDuzenle binaDuzenle = new frmBinaDuzenle();
            binaDuzenle.Show();
        }
